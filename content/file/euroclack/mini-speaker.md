...
- [Pushermann](https://pushermanproductions.com/product/clacktronics-6hp-eurorack-speaker-full-kit/)
- [Synthcube](https://synthcube.com/cart/clacktronics-euro-speaker-kit)
- [Thonk](https://www.thonk.co.uk/shop/clacktronics-speaker-kit/)
...
![Components in bag](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/components_bag.jpg)

## Other parts

There should also be a speaker, a panel, a PCB, a wire and a 16-to-10 pin power cable.

![Other parts](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/other_components.jpg)

## The PCB

![Bare board, back](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/01-bare_board_back.jpg)
...
![Resistors fitted](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/02-resistors_fitted.jpg)
...
![Strip the wire](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/03-strip_wire.jpg)
...
![Feed the wire](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/04-flex_wire.jpg)
...
![Fix the wire](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/05-fix_wire.jpg)

Feed the wire through the hole and bend it over so it holds in place so you can solder.

## Wire in place

![Wire soldered](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/06-wire_soldered.jpg)

The wire should now be in place and look like this.

## Film capacitors

![Fit capacitor](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/07-fix_capacitor.jpg)
...
![Add electrolytics](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/08-add_electrolytics.jpg)
...
![Add large electrolytic](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/09-add_large_electrolytic.jpg)
...
![Fit socket](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/10_fix_socket.jpg)
...
![Make sure socket is flush](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/11.Make_sure_socket.jpg)

Before properly soldering, make sure the socket is sitting flush on the PCB.

## Fit the power connector

![Fit euro power](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/12_fix_euro_power.jpg)
...
![Jack and pot](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/13_jack_and_pot.jpg)
...
![Jack and pot from the side](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/14-Jack_and_pot_side.jpg)

This shows how they should be fitted.

## Main assembly

![Panel and speaker](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/15_get_panel_speaker.jpg)

You should now have these three parts.

## Mount the speaker

![Mount speaker](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/16_mount_speaker.jpg)
...
![Completed speaker](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/17_completed_speaker.jpg)
...
![Trim wire](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/18_trim_wire.jpg)
...
![Soldered speaker](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/19_soldered_speaker.jpg)

It is built!

## Smoke test

![Simple test](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/20_simple_test.jpg)
...
- [iBOM](https://clacktronics.co.uk/euroclack/mini-speaker_kit/ibom.html) (right click to save)
...
- [JPEG front view](https://clacktronics.co.uk/euroclack/mini-speaker_kit/images/mini-speaker_kit_main_image.jpg) (1.2MB)
